        ...
        <div className="min-h-screen bg-background text-foreground">
                ...
                <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-headline text-primary flex items-center gap-2">
                           <Image src="/logo.svg" alt="logo" width={28} height={28} className="text-primary" />
            ...
            <main className="container mx-auto p-4 sm:p-6 lg:p-8">
                     ...
                     <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                                <div className="p-4 bg-muted/50 rounded-lg">{t('info.realAccount.method_card')}</div>
                                <div className="p-4 bg-muted/50 rounded-lg">{t('info.realAccount.method_digital')}</div>
                                <div className="p-4 bg-muted/50 rounded-lg">{t('info.realAccount.method_crypto')}</div>
                                <div className="p-4 bg-muted/50 rounded-lg">{t('info.realAccount.method_transfer')}</div>
                            </div>
                             <p className="text-sm text-muted-foreground pt-2">{t('info.realAccount.advantages.title')}</p>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4 text-sm text-muted-foreground">
                            ...
                            <div className="flex flex-wrap gap-4 pt-2">
                                <span className="font-mono bg-muted px-2 py-1 rounded">CySEC (Cyprus)</span>
                                <span className="font-mono bg-muted px-2 py-1 rounded">FCA (UK)</span>
                                <span className="font-mono bg-muted px-2 py-1 rounded">ASIC (Australia)</span>
                            </div>
                        </CardContent>
                    </Card>
             ...
             <footer className="bg-card border-t mt-12">
                <div className="container mx-auto py-4 px-4 sm:px-6 lg:px-8 text-center text-xs text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} Facebook AI by Meta. {t('info.footer.rights')}</p>
                    <p className="mt-1">{t('info.footer.warning')}</p>
                </div>
            </footer>
        </div>
    );
